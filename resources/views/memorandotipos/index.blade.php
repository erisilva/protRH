...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('memorandotipos.index') }}">Lista de Tipos de Memorando</a></li>
    </ol>
  </nav>
  {{-- avisa se um usuario foi excluido --}}
  @if(Session::has('deleted_memorandotipo'))
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Info!</strong>  {{ session('deleted_memorandotipo') }}
  ...
  @if(Session::has('create_memorandotipo'))
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
    <strong>Info!</strong>  {{ session('create_memorandotipo') }}
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
  ...
  <div class="btn-group py-1" role="group" aria-label="Opções">
    <a href="{{ route('memorandotipos.create') }}" class="btn btn-secondary btn-sm" role="button"><i class="fas fa-plus-square"></i> Novo Registro</a>
  ...
  <div class="table-responsive">
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>{{$memorandotipo->descricao}}</td>
                <td>
                  <div class="btn-group" role="group">
                    <a href="{{route('memorandotipos.edit', $memorandotipo->id)}}" class="btn btn-primary btn-sm" role="button"><i class="fas fa-edit"></i></a>
                    <a href="{{route('memorandotipos.show', $memorandotipo->id)}}" class="btn btn-primary btn-sm" role="button"><i class="fas fa-trash-alt"></i></a>
                  </div>
                </td>
            </tr>    
            @endforeach                                                 
  ...
  <p class="text-center">Página {{ $memorandotipos->currentPage() }} de {{ $memorandotipos->lastPage() }}. Total de registros: {{ $memorandotipos->total() }}.</p>
  <div class="container-fluid">
      {{ $memorandotipos->links() }}
  </div>
...
$(document).ready(function(){
    $('#perpage').on('change', function() {
        ...
        window.open("{{ route('memorandotipos.index') }}" + "?perpage=" + perpage,"_self");
    });

    $('#btnExportarCSV').on('click', function(){
        window.open("{{ route('memorandotipos.export.csv') }}","_self");
    });

    $('#btnExportarPDF').on('click', function(){
        window.open("{{ route('memorandotipos.export.pdf') }}","_self");
    });
}); 
</script>
@endsection