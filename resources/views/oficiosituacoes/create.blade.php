...
<div class="container">
  <form method="POST" action="{{ route('oficiosituacoes.store') }}">
    @csrf
    <div class="form-row">
    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-plus-square"></i> Incluir Situação do Ofício</button>
  </form>
