...
<div class="container">
  <form method="POST" action="{{ route('solicitacaosituacoes.store') }}">
    @csrf
    <div class="form-row">
    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-plus-square"></i> Incluir Situação da Solicitação</button>
  </form>
