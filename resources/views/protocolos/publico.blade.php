  ...
  <form>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control font-weight-bold" name="protocolo_situacao" value="{{ $protocolo->protocoloSituacao->descricao }}" readonly>
      </div>      
    </div>
    ...
    <div class="form-row">
      <div class="form-group col-md-8">
        <label for="resposta">Solução</label>
          <input type="text" class="form-control font-weight-bold" name="resposta" value="{{ $protocolo->resposta->descricao }}" readonly>  
      </div>
      <div class="form-group col-md-2">
